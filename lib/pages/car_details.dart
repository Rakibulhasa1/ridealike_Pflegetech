  ...
  RestApi.callAPI(
    ...
    json.encode({
      "BookingParams": {
        "CarID": param['CarID'],
        "StartDateTime":
            DateTime.parse(param['StartDate']).toUtc().toIso8601String(),
        "EndDateTime":
            DateTime.parse(param['EndDate']).toUtc().toIso8601String(),
...
class CarDetailsState extends State<CarDetails> {
  ...
  void handleShowAddCardModal() {
    showModalBottomSheet(
      ...
      context: context,
      builder: (context) {
        _bookingInfo["route"] = "/car_details";
        _bookingInfo["window"] = _carDetails['Availability']['RentalAvailability']['BookingWindow'];
        _bookingInfo["mileage"] = _carDetails['Preference'];
        _bookingInfo['FormattedAddress']=_carDetails['About']['Location']['FormattedAddress'];
        if (!_cardAdded) {
          AppEventsUtils.logEvent("card_added_false");
          return AddCard(bookingInfo: _bookingInfo);
        } else {
          AppEventsUtils.logEvent("card_added_true");
          // _bookingInfo['locLat']=_receivedData!["searchLatitude"]!=null?_receivedData!["searchLatitude"]:null;
          // _bookingInfo['locLong']=_receivedData!["searchLongitude"]!=null?_receivedData!["searchLongitude"]:null;
          // _bookingInfo['FormattedAddress']= _receivedData!['searchFormattedAddress']!=null ?_receivedData!['searchFormattedAddress']:_carDetails['About']['Location']['FormattedAddress'];
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      //AppEventsUtils.logEvent("car_details_view", params: {"type": "search"});
  ...
  _receivedData = ModalRoute.of(context)!.settings.arguments as Map;
      ...
      var ownProfileRes;
      var res = await fetchCarData(_receivedData!['CarID']);
      var res2 = await fetchProfileData(json.decode(res.body!)['Car']['UserID']);
      var res4 = await fetchCarReviews(_receivedData!['CarID']);
      _receivedData!['_userID'] = userID;

      var pricingResponse = await fetchPricingInfo(_receivedData);
//      var res5 = await fetchUserTrips(json.decode(res.body!)['Car']['UserID']);
      ...
      var resShowLocation;
      if (userID != null && _receivedData!['CarID'] != null) {
        resShowLocation =
            await fetchLocationStatus(userID, _receivedData!['CarID']);
      }
...
//        _userTrips = json.decode(res5.body!)['Trips'];
        ...
        if (pricingResponse != null) {
          pricingInfo = json.decode(pricingResponse.body!);
          print('pricingInfo$pricingInfo');
        }
        ...
        deliveryLimit=_carDetails['Pricing']['RentalPricing']['EnableCustomDelivery'];
        hour= (_carDetails['Availability']['RentalAvailability']['SameDayCutOffTime']['hours'])%12;
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image:
                          NetworkImage('$storageServerUrl/$i'),
                      fit: BoxFit.cover),
                ),
              );
            },
        ...
        _bookingInfo['startDate'] = _receivedData!['StartDate'] != ''
            ? _receivedData!['StartDate'].toString()
            : DateTime.now().toUtc();
        _bookingInfo['endDate'] = _receivedData!['EndDate'] != ''
            ? _receivedData!['EndDate'].toString()
            : DateTime.now().add(Duration(days: 4)).toUtc();
...
//      String userID = await storage.read(key: 'user_id');
  ...
  // longestTrip(Map _carDetails) {
  //   switch (_carDetails['Availability']['RentalAvailability']['LongestTrip']) {
  //     case 1:
  //       return '8 days';
  //     case 2:
  //       return '15 days';
  ...
  getAdvanceNotice(Map _carDetails) {
    switch ( _carDetails['Availability']['RentalAvailability']['AdvanceNotice']) {
      case 'AtLeast1Day':
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          Container(
                                            ...
                                            child: IconButton(
                                              icon:
                                                  Image.asset('icons/Back.png'),
                                              onPressed: () {
                                                // Navigator.pushNamed(
                                                //   context,
                                                //   '/discover_tab',
                                                // );
                                                Navigator.popUntil(context, ModalRoute.withName('/search_car_sort_tab'));
                                              },
                                            ),
                                          ),
                                        ],
                                  ...
                                  children: <Widget>[
                                    ...
                                    Ink(
                                      ...
                                      child: IconButton(
                                        ...
                                        color: Colors.white,
                                        onPressed: () {
                                          Object? completeShareMessage = _bookingInfo['carID'];
                                          String carDetailLink = '$carDetailsLink$completeShareMessage';
                                          Share.share(carDetailLink);
                                          ...
                                          SizedBox(
                                            ...
                                            child: Wrap(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Chip(label: Text('${getCurrentMileage(_carDetails)}'
                                                  ,
                                                  style: TextStyle(
                                                      fontFamily:
                                                      'Urbanist',
                                                ...
                                                _carDetails['Features']
                                                    ...
                                                    ? Chip(
                                                        label: Text(
                                                          '${ _carDetails['Features']['FuelType'] == '91-94 premium' ?
                                                          'Premium fuel' :
                                                          _carDetails['Features']['FuelType'] == '87 regular' ?
                                                          'Regular fuel' :
                                                          _carDetails['Features']['FuelType'] == 'electric' ?'Electric':

                                                          _carDetails['Features']['FuelType'] == 'diesel' ?'Diesel fuel':

                                                          _carDetails['Features']['FuelType']}'
                                                          ,
                                                          style: TextStyle(
                                                              fontFamily:
                                                                  'Urbanist',
                                                ...
                                                _carDetails['Features']
                                                        ...
                                                        ''
                                                    ? Chip(
                                                        label: Text( '${ _carDetails['Features']['Transmission'] == 'automatic' ?'Automatic':
                                                        _carDetails['Features']['Transmission'] == 'manual' ?'Manual':
                                                        _carDetails['Features']['Transmission']} transmission',
                                                          style: TextStyle(
                                                              fontFamily:
                                                                  'Urbanist',
                                                              fontSize: 14),
                                                            ...
                                                            child: Column(
                                                                ...
                                                                children: [
                                                                  _carDetails['Preference']
                                                                          ...
                                                                          "Limited"
                                                                      ? Text(
                                                                          _carDetails['Preference']['Limit'].toStringAsFixed(2) +
                                                                              ' km allowed daily, extra mileage is \$' +
                                                                              _carDetails['Pricing']['RentalPricing']['PerExtraKMOverLimit'].toStringAsFixed(2) +
                                                                              '/km',
                                                                          style:
                                                                              TextStyle(
                                                                            fontFamily:
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  Icon(Icons.adjust_rounded),
                                                  SizedBox(width: 8),
                                                  _carDetails['Availability']['RentalAvailability']['AdvanceNotice']!=null &&
                                                      _carDetails['Availability']['RentalAvailability']['AdvanceNotice']=='SameDay'?
                                                  SizedBox(width: MediaQuery.of(context).size.width*.75,
                                                    child: AutoSizeText(
                                                      'Cannot be booked after' +' '+
                                                          hour.toString()+
                                                          ':00'+' '+(num.parse((_carDetails['Availability']['RentalAvailability']['SameDayCutOffTime']['hours']).toStringAsFixed(2)) > 11.59 ? 'PM' : 'AM')+' '+'same day',
                                                      style: TextStyle(
                                                        fontFamily: 'Urbanist',
                                                        fontSize: 14,
                                                        color: Color(0xFF353B50),
                                                    ...
                                                    child: AutoSizeText(
                                                        'Host requires ${getAdvanceNotice(_carDetails)} '+'advance notice.',
                                                        style: TextStyle(
                                                          fontFamily: 'Urbanist',
                                                          fontSize: 14,
                                                          color: Color(0xFF353B50),
...
//                                          _setCircles(_bookingInfo);
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          SizedBox(width: 5),
                                                          Text(deliveryLimit==false?'Delivery not available':
                                          ...
                                          // Notes header
                                          _carDetails['About']['Location']['Notes'] !=
                                              null&&_carDetails['About']['Location']['Notes'] !=''?  SizedBox(height: 30):Container(),
                                          _carDetails['About']['Location']['Notes'] !=
                                              null&&_carDetails['About']['Location']['Notes'] !=''? Row(
                                            mainAxisAlignment:
                                                MainAxisAlignment.spaceBetween,
                                            children: <Widget>[
                                              Expanded(
                                          ...
                                          _carDetails['About']['Location']['Notes'] !=
                                              null&&_carDetails['About']['Location']['Notes'] !=''? SizedBox(height: 10):Container(),
                                          _carDetails['About']['Location']['Notes'] !=
                                              null&&_carDetails['About']['Location']['Notes'] !=''? Row(
                                            children: <Widget>[
                                              Expanded(
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(
                                      child: Row(children: [
                                        pricingInfo['Booking']['Pricing']!=null && pricingInfo['Booking']['Pricing']['Total']!=null?
                                        Text(
                                          '\$' + double.parse(pricingInfo['Booking']['Pricing']['Total'].toString()).round().toString(),
                                              // double.parse(_carDetails['Pricing']['RentalPricing']['PerDay'].toString()).round().toString(),
...
//                                    _carDetails['Pricing']['RentalPricing']
                                    ...
                                    _loggedIn
                                        ? Container(
                                            ...
                                            children: [
                                              SizedText(
                                                deviceWidth: SizeConfig.deviceWidth!,
                                                textWidthPercentage: 0.25,
                                                textAlign: TextAlign.right,
                                                text: '${pricingInfo['Booking']['Pricing']['DiscountPercentage']}% off applied',
                                                fontFamily: 'Urbanist',
                                                fontSize: 14,
                                                textColor: Color(0xFF353B50),
                                              ),
...
//                                        : new Container(),
                                ...
                                Padding(padding: const EdgeInsets.only(
                                    left: 8, right: 8),
                                    child: Text('RideAlike has temporarily blocked your profile. Please contact admin@ridealike.com.',style:TextStyle(
                                      fontFamily: 'Urbanist',
                                      fontSize: 14,
                                      color: Color(0xFF353B50),
                                    ),)
                                ):
                                profileVerificationResponse!.verification!.phoneVerification!.verificationStatus ==
                                    'Verified' &&
                                    profileVerificationResponse!.verification!.emailVerification!.verificationStatus ==
                                        'Verified'
                                ...
                                (_carDetails['Verification'] !=null && _carDetails['Verification']['VerificationStatus']=='Updated')||
                                    _carDetails['Availability']['RentalAvailability']['BookingWindow']=='DatesUnavailable'? Padding(
                                  padding: const EdgeInsets.only(
                                      left: 8, right: 8),
                                  child: Text('This vehicle is currently unavailable for booking.',  style:TextStyle(
                                    fontFamily: 'Urbanist',
                                    fontSize: 14,
                                    color: Color(0xFF353B50),
                                  ),),
                                    ...
                                    : Container(),
                                _loggedIn
                                    ? profileVerificationResponse!.verification!.phoneVerification
                                                   ! .verificationStatus ==
                                                'Verified' &&
                                            profileVerificationResponse
                                                    !.verification!
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text(
                                  '\$' +
                                      double.parse(_carDetails['Pricing']
                                      ['RentalPricing']['PerDay']
                                          .toString())
                                          .round()
                                          .toString(),
                                  style: TextStyle(
                                ...
                                onPressed: profileVerificationResponse!
                                    ...
                                    (_carDetails['Verification'] != null &&
                                        ...
                                        ['VerificationStatus'] !=
                                            'Updated')
                                    ? () async {
                                  String? profileID = await storage
                                      .read(key: 'profile_id');

                                  if (profileID != null) {
                                    fetchCardInfo(userID).then(
                                            (value) {
                                          setState(() {
