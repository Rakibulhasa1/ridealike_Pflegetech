...
class AddFeature extends StatefulWidget {
  @override
  State createState() => AddFeatureState();
}

class AddFeatureState extends State<AddFeature> {
                                ...
                                children: <Widget>[
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(_descriptionCharCount.toString() +
                                          '/500',
                                        style: TextStyle(
                                          fontFamily: 'Urbanist',
                                          fontSize: 14,
                            ...
                            child: ElevatedButton(
                             ...
                             // onPressed: _isButtonDisabled ? null : () async {
                              onPressed: () async {
                                ...
                                setState(() {
                                  receivedData['_customFeatures'].add(_customFeature);
                                });
