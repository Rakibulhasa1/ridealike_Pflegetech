...
class TripStarted extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    AppEventsUtils.logEvent("page_viewed", params: {"page_name" : "Trip Started"});
                ...
                Padding(
                  ...
                  child: Center(
                    child: Text(
                      ...
                      "You can always find details of your current trip, including proof of insurance, by selecting the Trips icon.",
                        style: TextStyle(
                          fontFamily: 'Urbanist',
                          fontSize: 14,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(
                        ...
                        arguments: {'tripType': 'Current',  'trip': tripDetails},
                      );
                    },
                    child: Text('Ok',
                      style: TextStyle(
