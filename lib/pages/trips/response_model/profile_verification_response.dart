class ProfileVerificationResponseGuest {
  Verification? verification;
  Status? status;

  ProfileVerificationResponseGuest({this.verification, this.status});

  ProfileVerificationResponseGuest.fromJson(Map<String, dynamic> json) {
