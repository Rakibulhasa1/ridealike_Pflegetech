...
class RentoutHostEndTripDetails extends StatefulWidget {
  @override
  State createState() => RentoutHostEndTripDetailsState();
}

class RentoutHostEndTripDetailsState extends State<RentoutHostEndTripDetails> {
...
//  final inspectionInfoBloc = GuestTripDetailsInfoBloc();
  ...
  void initState() {
    ...
    AppEventsUtils.logEvent("page_viewed",
        params: {"page_name": "Rentout Host End Trip Details"});
  }
  ...
  Widget build(BuildContext context) {
    ...
    ticketsamount.text = inspectionInfo
        .inspectionInfo!.endRentout!.ticketsTollsReimbursement!.amount
        .toString();
                                  ...
                                  child: Padding(
                                    ...
                                    GridView.count(
                                      ...
                                      children: List.generate(9, (index) {
                                        String imageUrl = '';
                                        String imageId = '';
                                        if (index < inspectDataSnapshot.data!.tripEndInspectionRentout!.damageImageIDs!.length &&
                                            inspectDataSnapshot.data!.tripEndInspectionRentout!.damageImageIDs![index] != '') {
                                          imageId = inspectDataSnapshot.data!.tripEndInspectionRentout!.damageImageIDs![index];
                                        ...
                                        return GestureDetector(
                                          onTap: () {
                                            if (imageId.isNotEmpty) {
                                              ...
                                              for (int i = 0; i < 9; i++) {
                                                if (i < inspectDataSnapshot.data!.tripEndInspectionRentout!.exteriorImageIDs!.length &&
                                                    inspectDataSnapshot.data!.tripEndInspectionRentout!.exteriorImageIDs![i] != '') {
                                  ...
                                  child: Padding(
                                    ...
                                    GridView.count(
                                      ...
                                      children: List.generate(3, (index) {
                                        String imageUrl = '';
                                        String imageId = '';
                                        if (index < inspectDataSnapshot.data!.tripEndInspectionRentout!.exteriorImageIDs!.length &&
                                            inspectDataSnapshot.data!.tripEndInspectionRentout!.exteriorImageIDs![index] != '') {
                                          imageId = inspectDataSnapshot.data!.tripEndInspectionRentout!.exteriorImageIDs![index];
                                          imageUrl = '$storageServerUrl/$imageId';
                                      ...
                                      children: <Widget>[
                                        ...
                                        GridView.count(
                                          ...
                                          children: List.generate(3, (index) {
                                            String imageUrl = '';
                                            String imageId = '';
                                            if (index < inspectDataSnapshot.data!.tripEndInspectionRentout!.interiorImageIDs!.length &&
                                                inspectDataSnapshot.data!.tripEndInspectionRentout!.interiorImageIDs![index] != '') {
                                              imageId = inspectDataSnapshot.data!.tripEndInspectionRentout!.interiorImageIDs![index];
                                              imageUrl = '$storageServerUrl/$imageId';
                                ...
                                Container(
                                  ...
                                  GridView.count(
                                    ...
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: () {
                                          String imageUrl = inspectDataSnapshot.data!.tripEndInspectionRentout!.fuelImageIDs![1] != ''
                                              ? '$storageServerUrl/${inspectDataSnapshot.data!.tripEndInspectionRentout!.fuelImageIDs![1]}'
                                              : '$storageServerUrl/${inspectionInfo.inspectionInfo!.endRentout!.fuelImageIDs![1]}';
                                ...
                                Container(
                                  ...
                                  GridView.count(
                                    ...
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: () {
                                          String imageUrl = inspectDataSnapshot.data!.tripEndInspectionRentout!.mileageImageIDs![1] != ''
                                              ? '$storageServerUrl/${inspectDataSnapshot.data!.tripEndInspectionRentout!.mileageImageIDs![1]}'
                                              : (inspectionInfo.inspectionInfo!.endRentout!.mileageImageIDs!.isNotEmpty
                                              ? '$storageServerUrl/${inspectionInfo.inspectionInfo!.endRentout!.mileageImageIDs![1]}'
                                              : '');
                                        ...
                                        child: inspectDataSnapshot.data!.tripEndInspectionRentout!.mileageImageIDs![1] == '' &&
                                            (inspectionInfo.inspectionInfo!.endRentout!.mileageImageIDs!.isEmpty ||
                                                inspectionInfo.inspectionInfo!.endRentout!.mileageImageIDs![1] == '')
                                            ? Container(
                                          child: Image.asset('icons/Scan-Placeholder.png'),
                                          decoration: BoxDecoration(
                                            color: Color(0xFFE0E0E0),
