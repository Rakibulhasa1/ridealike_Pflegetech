...
class OdometerInspectionUI extends StatefulWidget {
  @override
  State createState() => OdometerInspectionUIState();
}

class OdometerInspectionUIState extends State<OdometerInspectionUI> {
                                            ...
                                            child: startTripDataSnapshot
                                              ...
                                              SizedBox(
                                                  child: Image(
                                                    fit: BoxFit.fill,
                                                    image: NetworkImage(
                                                        '$storageServerUrl/${startTripDataSnapshot.data!.tripStartInspection!.interiorImageIDs![0]}'),
                                                  ),
                                                  width:
                                                  double.maxFinite),
                                              Positioned(
                                              ...
                                              child: startTripDataSnapshot
                                                ...
                                                SizedBox(
                                                    child: Image(
                                                      fit: BoxFit.fill,
                                                      image: NetworkImage(
                                                          '$storageServerUrl/${startTripDataSnapshot.data!.tripStartInspection!.interiorImageIDs![1]}'),
                                                    ),
                                                    width: double
                                                        .maxFinite),
                                                Positioned(
                                              ...
                                              child: startTripDataSnapshot
                                                ...
                                                SizedBox(
                                                    child: Image(
                                                      fit: BoxFit.fill,
                                                      image: NetworkImage(
                                                          '$storageServerUrl/${startTripDataSnapshot.data!.tripStartInspection!.interiorImageIDs![2]}'),
                                                    ),
                                                    width: double
                                                        .maxFinite),
                                                Positioned(
                                      ...
                                      children: [
                                        Expanded(
                                            child: TextField(
                                              maxLength: 6,
                                              onChanged: (mileage){
                                                startTripDataSnapshot.data!.tripStartInspection!.mileage = int.parse(mileage.toString());
