...
class ChangeRequestUpcomingTripDuration extends StatefulWidget {
  final bookingInfo;

  ChangeRequestUpcomingTripDuration({this.bookingInfo});

  @override
  State createState() => BookingTripDurationState(bookingInfo);
}

class BookingTripDurationState
    extends State<ChangeRequestUpcomingTripDuration> {
  var bookingInfo;
 ...
 DatePickerRangeStyles? styles= DatePickerRangeStyles(
  ...
  //     },
  //   );
  //   print('hey i am clicked by akter');
  // }
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      styles = DatePickerRangeStyles(
          currentDateStyle: TextStyle(color: Colors.black), selectedSingleDateDecoration: BoxDecoration(
        color: Color(0xFFFF8F68),
        borderRadius: BorderRadius.circular(8.0), // Add border radius
      ),
        selectedPeriodMiddleDecoration: BoxDecoration(
      ...
      //
      _firstDate = DateTime.now().subtract(Duration(days: 10));
                        ...
                        ? Container(
                            ...
                            child: RangePicker(
                              ...
                              onChanged: (DatePeriod newPeriod) {
                                ...
                                // //TODO
                                // print(
                                //     "savedata ${_selectedPeriod!.start} ${_selectedPeriod!.end}");
                                // if (diff > 1) {
                                //   print("savedata false");
                                //   bookingInfo['saveData'] = false;
                                // }
                                // //
                                              ...
                                              return Slider(
                                                ...
                                                onChanged: (values) {
                                                  if (!hasError) {
                                                    ...
                                                    print(
                                                        "updateReturnHourSelection(noUpdate: true)");
...
fontSize: 18
                                                    ...
                                                    content: Text(
                                                        'You can\'t select more than 30 days ',style: TextStyle(
                                                        fontFamily: 'Urbanist',
fontSize: 16
