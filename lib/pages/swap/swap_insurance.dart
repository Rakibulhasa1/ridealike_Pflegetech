...
class SwapInsurance extends StatefulWidget {
  @override
  State createState() => SwapInsuranceState();
}

class SwapInsuranceState extends State<SwapInsurance> {
  @override
  Widget build(BuildContext context) {
    dynamic receivedData = ModalRoute.of(context)?.settings.arguments;

    //print(receivedData);
    print(":::${receivedData['_insuranceType']}:::");
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      setState(() {
                        receivedData['_insuranceType'] = 'Minimum';
                      });
                    },
                    child: Container(
                      padding: EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        border: receivedData['_insuranceType'] == 'Minimum'
                            ? Border.all(
                                width: 1.0, color: const Color(0xFFEA9A62))
                            : Border.all(color: Colors.transparent),
                        color: receivedData['_insuranceType'] != 'Minimum'
                            ? Color(0xffF2F2F2)
                            : Colors.transparent,
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      setState(() {
                        receivedData['_insuranceType'] = 'Standard';
                      });
                    },
                    child: Container(
                      padding: EdgeInsets.all(16),
