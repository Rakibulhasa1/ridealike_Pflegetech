...
import 'package:ridealike/pages/dashboard/reviews.dart' as _reviewPageView;
...
class DashboardReviewsTab extends StatefulWidget {
  @override
  _DashboardReviewsTabState createState() => _DashboardReviewsTabState();
}

class _DashboardReviewsTabState extends State<DashboardReviewsTab> {
  int _tab = 1;
        ...
        builder: (context, snapshot){
          ...
          MapButton(
            onPressed: () async {
              ...
              if (!_mapClick) {
                _mapClick = true;
                var _newCarData = await discoverBloc.callFetchNewCars();
