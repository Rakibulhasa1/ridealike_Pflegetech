...
import 'package:ridealike/pages/dashboard/manage_calendar.dart'
    as _dashboardCalendar;
...
class DashboardManageCalendarTab extends StatefulWidget {
  @override
  _DashboardManageCalendarTabState createState() =>
      _DashboardManageCalendarTabState();
}

class _DashboardManageCalendarTabState
    extends State<DashboardManageCalendarTab> {
  int _tab = 1;
  ...
  var pages = [
    ...
    new _dashboardCalendar.DashboardManageCalendar(),
