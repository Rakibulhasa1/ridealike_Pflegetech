...
import 'package:ridealike/widgets/available_coupon_shimmer.dart';
...
class DashBoardEditPricing extends StatefulWidget {
  @override
  State createState() => DashBoardEditPricingState();
}

class DashBoardEditPricingState extends State<DashBoardEditPricing> {
            ...
            showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  backgroundColor: Colors.white,
                  content: Text(
                    "Do you want to save the pricing changes?",
                    style: TextStyle(
                      fontFamily: 'Urbanist',
                      fontSize: 18,
                    ),
                  ...
                  actions: <Widget>[
                    OutlinedButton(
                      style: OutlinedButton.styleFrom(
                        ...
                        side: BorderSide(color: Color(0xffFF8F68)),
                                  ...
                                  progressIndicatorSnapshot
                                    ...
                                    if (payoutDataResp !=
                                        ...
                                        payoutDataResp.payoutMethod!.payoutMethodType ==
                                            'payout_undefined') {
                                      Navigator.pushNamed(context, '/dashboard_tab', arguments: payoutDataResp)
                                          .then((value) {
                                        if (response !=
                                            null) {
                                          if (pushNeeded) {
