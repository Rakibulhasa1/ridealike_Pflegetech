...
class EditDashboardEditFeature extends StatefulWidget {
  @override
  State createState() => EditDashboardEditFeatureState();
}

class EditDashboardEditFeatureState extends  State<EditDashboardEditFeature> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero,() async {
      AppEventsUtils.logEvent("page_viewed", params: {"page_name" : "Edit Dashboard Edit A Feature"});
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              int indexOfData = receivedData['_carFeatures']['Features']['CustomFeatures'].indexOf(receivedData['_data']);

                              setState(() {
                                receivedData['_carFeatures']['Features']['CustomFeatures'][indexOfData]['Name'] = _nameController.text;
                                receivedData['_carFeatures']['Features']['CustomFeatures'][indexOfData]['Description'] = _descriptionController.text;
                                receivedData['_carFeatures']['Features']['CustomFeatures'][indexOfData]['ImageIDs'] = [_imageID1, _imageID2, _imageID3];
                              });
