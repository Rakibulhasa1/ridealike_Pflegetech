...
class EditDashboardVehicleAvailability extends StatefulWidget {
  @override
  State createState() => EditDashboardVehicleAvailabilityState();
}

class EditDashboardVehicleAvailabilityState extends  State<EditDashboardVehicleAvailability> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero,() async {
      AppEventsUtils.logEvent("page_viewed", params: {"page_name" : "Edit Dashboard Vehicle Availability"});
      final Map _receivedData = ModalRoute.of(context)!.settings.arguments as Map;

      setState(() {
        _carID = _receivedData['ID'];

        _sameDayCutOff = _receivedData['Availability']['RentalAvailability']['SameDayCutOffTime']['hours'].toDouble();
        _shortestTrip = _receivedData['Availability']['RentalAvailability']['ShortestTrip'].toDouble();
        _longestTrip = _receivedData['Availability']['RentalAvailability']['LongestTrip'].toDouble();
        _advanceNotice = _receivedData['Availability']['RentalAvailability']['AdvanceNotice'];
        _bookingWindow = _receivedData['Availability']['RentalAvailability']['BookingWindow'];

        _swapWithin = _receivedData['Availability']['SwapAvailability']['SwapWithin'].toDouble();
        _economy = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['Economy'];
        _compact = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['Compact'];
        _midSize = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['MidSize'];
        _fullSize = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['FullSize'];
        _sports = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['Sports'];
        _compactSUV = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['CompactSUV'];
        _midSizeSUV = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['MidSizeSUV'];
        _fullSizeSUV = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['FullSizeSUV'];
        _sportsSUV = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['SportsSUV'];
        _pickupTruck = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['PickupTruck'];
        _minivan = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['Minivan'];
        _van = _receivedData['Availability']['SwapAvailability']['SwapVehiclesType']['Van'];

        switch(_receivedData['Availability']['RentalAvailability']['ShortestTrip']) {
          case 1:
        ...
        switch(_receivedData['Availability']['RentalAvailability']['LongestTrip']) {
          case 1:
                                      ...
                                      Expanded(
                                        child: ElevatedButton(
                                          style: ElevatedButton.styleFrom(
                                            ...
                                            padding: EdgeInsets.all(16.0),
                                            backgroundColor: _advanceNotice == 'SameDay' ? Color(0xFFFF8F62) : Color(0xFFE0E0E0).withOpacity(0.5),
                                          ),
                                  ...
                                  Row(
                                    children: <Widget>[
                                      Expanded(
                                        child: ElevatedButton(
                                          style: ElevatedButton.styleFrom(
                                            backgroundColor: _advanceNotice == 'AtLeast1Day' ? Color(0xFFFF8F62) : Color(0xFFE0E0E0).withOpacity(0.5),
                                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0)),
                                            elevation: 0.0,
                                            padding: EdgeInsets.all(16.0),
                                          ),
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: ElevatedButton(
                                          style: ElevatedButton.styleFrom(
                                            padding: EdgeInsets.all(16.0),
                                            backgroundColor: _advanceNotice == 'AtLeast3Day' ? Color(0xFFFF8F62) : Color(0xFFE0E0E0).withOpacity(0.5),
                                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0)),
                                      ...
                                      Expanded(
                                        child: ElevatedButton(
                                          style: ElevatedButton.styleFrom(
                                            elevation: 0.0,
                                            padding: EdgeInsets.all(16.0),
                                            backgroundColor: _advanceNotice == 'AtLeast5Day' ? Color(0xFFFF8F62) : Color(0xFFE0E0E0).withOpacity(0.5),
                                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0)),
                                      ...
                                      Expanded(
                                        child: ElevatedButton(
                                          style: ElevatedButton.styleFrom(
                                            elevation: 0.0,
                                            padding: EdgeInsets.all(16.0),
                                            backgroundColor: _advanceNotice == 'AtLeast7Day' ? Color(0xFFFF8F62) : Color(0xFFE0E0E0).withOpacity(0.5),
                                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0)),
...
Future<http.Response> setCarAvailability() async {
  ...
  try {
    res = await http.post(
      Uri.parse(setAvailabilityUrl),
      // setAvailabilityUrl as Uri,
      body: json.encode(
        {
          "CarID": _carID,
          "Availability": {
