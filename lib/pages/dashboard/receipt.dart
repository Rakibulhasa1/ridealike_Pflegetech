...
class ReceiptState extends State<Receipt> {
  ...
  void _printScreen() async {
    ...
    pdf.addPage(pw.MultiPage(
        pageFormat: PdfPageFormat.a4,maxPages: 1,
      ...
      children: [
        ...
        bookingStatus != 'Cancelled' &&
          ...
          children: [
            ...
            : pw.Container(),
        bookingStatus != 'Cancelled' && tripIDValues != null && tripIDValues!.startedAt != null ? pw.SizedBox(height: _textMargin) : pw.Container(),
        ///end trip date
        bookingStatus != 'Cancelled' &&
            tripIDValues != null &&
        ...
        user == 'Guest'
          ...
          children: [
            ...
            pw.Text(
              bookingStatus == 'Cancelled' && user == 'Host'
                  ? '\$' '0.00'
                  : '\$' + insuranceFee!.toStringAsFixed(2).replaceAll("-", ""),
              style: pw.TextStyle(
                fontSize: 15,
              ),
            ),
          ...
          children: [
            ...
            bookingStatus == 'Cancelled' && user == 'Host'
              ...
              style: pw.TextStyle(
                ...
                : pw.Text(
              fee > 0 ? '\$' + (fee.toStringAsFixed(2)) : 0.00 as String,
              style: pw.TextStyle(
                fontSize: 15,
              ),
            ),
    ...
    pdf.addPage(pw.MultiPage(build:(pw.Context context) => <pw.Widget>[
      ...
      pw.Row(
        children: [
          user=='Guest'?
              pw.Text("Return Fee", style: pw.TextStyle(fontSize: 16,),)
              :pw.Text("Return Credit", style: pw.TextStyle(fontSize: 16,),),
          pw.Spacer(),
          pw.Text('${lateReturnFee.toStringAsFixed(2).replaceAll("-", "")}', style: pw.TextStyle(fontSize: 14,)),
        ],
      ):pw.Container(),
      bookingStatus != 'Cancelled' && lateReturnFee!=null &&
          lateReturnFee!=0?pw.SizedBox(height: _textMargin):pw.Container(),
      ...
      user == 'Guest' &&
        ...
        pw.Row(
          children: [
            ...
            pw.Spacer(),
            pw.Text(
              '\$' + (ridealikeCouponFee!.toStringAsFixed(2).replaceAll("-", "")),
              style: pw.TextStyle(
                fontSize: 15,
              ),
            ),
        ...
        children: [
          ...
          _receiptData!.booking!.cancellationFee != null
            ...
            _receiptData!.booking!.cancellationFee!.refund !=
                null ? '\$' + (_receiptData!.booking!.cancellationFee!.refund!.toStringAsFixed(2)).replaceAll("-", "")
                : '\$' + '0.00',
            style: pw.TextStyle(
              fontSize: 15,
            ),
  ...
  void initState() {
    super.initState();
    AppEventsUtils.logEvent("page_viewed", params: {"page_name" : "Receipt"});
    Future.delayed(Duration.zero, () async {
      ...
      setState(() {
        _receiptData = RentalBookingReceiptResponse.fromJson(json.decode(res.body!));
        tripID = _receiptData!.booking!.bookingID;
        tripIdRBN = _receiptData!.booking!.rBN!;
        pickupDate = DateFormat('EE MMM dd, hh:00 a').format(
            DateTime.parse(_receiptData!.booking!.params!.startDateTime!)
                .toLocal());
        returnDate = DateFormat('EE MMM dd, hh:00 a').format(DateTime.parse(json.decode(res.body!)['Booking']['Params']['EndDateTime']).toLocal());
        locationName = _receiptData!.booking!.params!.pickupReturnLocation!.address!;
        if (user == 'Guest' && _receiptData!.booking!.hostPricing!.tripDurationInString != null) {
          rate = _receiptData!.booking!.pricing!.tripDurationInString!;
        } else {
          rate = _receiptData!.booking!.hostPricing!.tripDurationInString!;
        }
        if (user == 'Guest') {
          price = _receiptData!.booking!.pricing!.tripPrice!;
        } else {
          price = _receiptData!.booking!.hostPricing!.tripPrice!;
        }
        if (user == 'Guest') {
          discount = _receiptData!.booking!.pricing!.discount!;
        } else {
          discount = _receiptData!.booking!.hostPricing!.approvedDiscount!;
        }
        fee = user == 'Guest'
            ? _receiptData!.booking!.pricing!.tripFee!
            : _receiptData!.booking!.hostPricing!.ridealikeFee!;
        insurance = _receiptData!.booking!.params!.insuranceType == 'Standard' ? 0 : 20;

        // total = user == 'Guest' ? _receiptData!.booking!.pricing!.total : _receiptData!.booking!.hostPricing.total;
        ...
        deliveryFee = user == 'Guest'
            ? _receiptData!.booking!.pricing!.deliveryFee!
            : _receiptData!.booking!.hostPricing!.deliveryFee!;
        deliveryFeeString = user == 'Guest' ? _receiptData!.booking!.pricing!.deliveryRateInString! : '';

        discountPercentage = _receiptData!.booking!.pricing!.discountPercentage!;
        insuranceFee = _receiptData!.booking!.pricing!.insuranceFee!;
        ridealikeCouponFee = _receiptData!.booking!.pricing!.ridealikeCoupon!;
        couponAvailed = _receiptData!.booking!.pricing!.couponAvailed;
        hostRidealikeFee = _receiptData!.booking!.hostPricing!.ridealikeFee!;
        ...
        cancelledBookingDates = _receiptData!.booking!.cancellationFee != null
            ? DateFormat('EE MMM dd, hh:mm a').format(DateTime.parse(
                    _receiptData!.booking!.cancellationFee!.cancelledDate!).toLocal()) : '';
        ...
        if (json.decode(res.body!) != null) {
          _receiptCarData = {
            "CarName": tripArgument.car==null || tripArgument.hostProfile!.verificationStatus =="Undefined"?"Deleted Car" : json.decode(res2.body!)['Car']['About']['Year'] +
                ' ' +
                json.decode(res2.body!)['Car']['About']['Make'] +
                ' ' +
                json.decode(res2.body!)['Car']['About']['Model'],
            "Host":  tripArgument.hostProfile!.verificationStatus =="Undefined"?"Deleted Host Profile":hostName,
            "Guest":   tripArgument.guestProfile!.verificationStatus =="Undefined"?"Deleted Guest Profile":guestName,
            "mileage":tripArgument.car==null || tripArgument.hostProfile!.verificationStatus =="Undefined"?"Undefined": json.decode(res2.body!)['Car']['Preference']
                ['DailyMileageAllowance'],
            "mileageLimit": tripArgument.car==null || tripArgument.hostProfile!.verificationStatus =="Undefined"?"Undefined" : json.decode(res2.body!)['Car']['Preference']
                ['Limit'],
          };
        }
        ...
        if (tripIDValues != null &&
            tripIDValues!.endedAt != null ) {
          endedTimeFormat = DateFormat('EE MMM dd, hh:mm a').format(endedAtTripTime!.toLocal());

        }

        if (tripIDValues != null &&
            tripIDValues!.startedAt != null) {
          startedTripIdTimeFormat = DateFormat('EE MMM dd, hh:mm a').format(startedAtTripTime!.toLocal());
        ...
        if(tripIDValues!=null){
          if(user=='Guest'){
            total=tripIDValues!.guestTotal!;
          } else{
            total=tripIDValues!.hostTotal!;
          }
        }
      });
    });
      ...
      appBar: new AppBar(
        ...
        actions: [
          GestureDetector(
            onTap: () {
              if(
                (fuelChargeFee!=null && fuelChargeFee!=0)
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          Text(
                           _receiptData!.booking!.noOfTripRequests=="0"?"Receipt" : ' Initial Receipt',
                            style: TextStyle(
                      ...
                      _receiptData!.booking!.bookingStatus != 'Cancelled' &&
                        ...
                        children: [
                          ...
                          : Container(),
                      _receiptData!.booking!.bookingStatus != 'Cancelled' &&
                          (tripIDValues != null && tripIDValues!.startedAt!= null )
                          ? Divider(color: Color(0xFFE7EAEB))
                          : Container(),
                      ///ended Date//
                      _receiptData!.booking!.bookingStatus != 'Cancelled' &&
                      ...
                      user == 'Guest'
                          ...
                          : Container(),
                      user == 'Guest' ? Divider(color: Color(0xFFE7EAEB)) : Container(),
                      ...
                      Row(
                        ...
                        children: [
                          SizedText(
                            ...
                            text:user=='Guest'?
                            'Late Pickup Fee':'Late Pickup Credit',
                            fontFamily: 'Urbanist',
                            fontSize: 16,
                      ...
                      Row(
                        ...
                        children: [
                          SizedText(
                            ...
                            textWidthPercentage: 0.7,
                            text:user=='Guest'?
                            'Cleaning Fee':'Cleaning Fee Credit' ,
                            fontFamily: 'Urbanist',
                            fontSize: 16,
                            textColor: Color(0xff371D32),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          SizedText(
                            ...
                            textWidthPercentage: 0.7,
                            text:user=='Guest'?
                            'Extra Mileage Charge':'Extra Mileage Credit',
                            fontFamily: 'Urbanist',
                            fontSize: 16,
                            textColor: Color(0xff371D32),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          SizedText(
                            ...
                            textWidthPercentage: 0.7,
                            text: user=='Guest'?
                            'Late Return Fee':'Late Return Credit',
                            fontFamily: 'Urbanist',
                            fontSize: 16,
                            textColor: Color(0xff371D32),
                          ),
                      ...
                      bookingStatus != 'Cancelled' && lateReturnFee!=null &&
                          lateReturnFee!=0?Divider(color: Color(0xFFE7EAEB)):Container(),
                                    ...
                                    children: [
                                      ...
                                      _receiptData!.booking!.cancellationFee != null
                                          ? user == 'Guest'
                                              ...
                                              : Text(
                                                  _receiptData!.booking!.cancellationFee!.cancellationProfit != null && whoGained != 'RideAlike'
                                                      ? '\$' +
                                                          _receiptData!.booking!.cancellationFee!.cancellationProfit!.ammount!.toStringAsFixed(2).replaceAll("-", "")
                                                      : '\$' + '0.00',
                                                  style: TextStyle(
                                                    fontFamily: 'Urbanist',
                                                    fontSize: 14,
