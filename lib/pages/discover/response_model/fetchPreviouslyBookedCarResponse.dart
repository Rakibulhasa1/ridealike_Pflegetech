class FetchPreviouslyBookedCarResponse {
  List<Cars>? cars;
  Status? status;

  FetchPreviouslyBookedCarResponse({this.cars, this.status});

  FetchPreviouslyBookedCarResponse.fromJson(Map<String, dynamic> json) {
    if (json['cars'] != null) {
      cars =  <Cars>[];
      json['cars'].forEach((v) {
