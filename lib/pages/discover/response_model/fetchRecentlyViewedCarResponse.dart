class FetchRecentlyViewedCarResponse {
  List<Cars>? cars;
  Status? status;

  FetchRecentlyViewedCarResponse({this.cars, this.status});

  FetchRecentlyViewedCarResponse.fromJson(Map<String, dynamic> json) {
    if (json['cars'] != null) {
      cars =  <Cars>[];
      json['cars'].forEach((v) {
