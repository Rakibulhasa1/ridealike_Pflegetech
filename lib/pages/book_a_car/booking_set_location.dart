...
import 'booking_custom_location.dart';
import 'booking_info.dart';



class BookingSetLocation extends StatefulWidget {
  final bookingInfo;

  BookingSetLocation({this.bookingInfo});

  @override
  State createState() => BookingSetLocationState(bookingInfo);
}

class BookingSetLocationState extends State<BookingSetLocation> {
  var bookingInfo;

  BookingSetLocationState(this.bookingInfo);
 ...
 Set<Circle>? _circles;
  ...
  void initState() {
    ...
    if (bookingInfo["defaultAddress"] != null) {
      _defaultFreeLocation = bookingInfo['FormattedAddress'];
    } else {
