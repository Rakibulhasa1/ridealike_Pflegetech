...
class BookingCustomLocation extends StatefulWidget {
  final bookingInfo;

  BookingCustomLocation({this.bookingInfo});

  @override
  State createState() => BookingCustomLocationState(bookingInfo);
}

class BookingCustomLocationState extends State<BookingCustomLocation> {
  var bookingInfo;

  BookingCustomLocationState(this.bookingInfo);
                ...
                child: SearchMapPlaceWidget(
                  ...
                  onSelected: (place) async {
                    ...
                    setState(() {
                      ...
                      formattedAddressName = geolocation.fullJSON["formatted_address"].toString();
                      ...
                      onTap: () async {
                        try {
                          ...
                          if (_currentPosition != null &&
                            ...
                            handleShowSetLocationModal(context);
                          }
                        } catch (e) {
                          await pr!.hide();
                          print(e);
