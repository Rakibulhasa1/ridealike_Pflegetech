...
import 'package:ridealike/pages/profile/questions_details.dart' as _faqsQuestionsDetailsTab;
...
class FAQsQuestionsDetailsTab extends StatefulWidget{
  @override
  _FAQsQuestionsDetailsTabState createState() => _FAQsQuestionsDetailsTabState();
}

class _FAQsQuestionsDetailsTabState extends State<FAQsQuestionsDetailsTab> {
  int _tab = 4;
  // bool _hasCar;
  ...
  var _notHasCarPages = [
    ...
    new _faqsQuestionsDetailsTab.FAQsQuestionsDetails()
  ];
