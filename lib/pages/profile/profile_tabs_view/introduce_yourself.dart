...
import 'package:ridealike/pages/profile/introduce_yourself_view.dart' as  _introduceYourselfView;
...
class IntroduceYourself extends StatefulWidget {
  @override
  State createState() => IntroduceYourselfState();
}

class IntroduceYourselfState extends State<IntroduceYourself> {
  int _tab = 4;
  // bool _hasCar;
  ...
  var _notHasCarPages = [
    ...
    new _introduceYourselfView.IntroduceYourselfView()
  ];
