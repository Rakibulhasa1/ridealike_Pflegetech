...
import 'package:ridealike/pages/profile/payout_method.dart' as _payoutMethodTab;
...
class PayoutMethodTab extends StatefulWidget{
  @override
  _PayoutMethodTabState createState() => _PayoutMethodTabState();
}

class _PayoutMethodTabState extends State<PayoutMethodTab> {
  int _tab = 4;
  // bool _hasCar;
  ...
  var _notHasCarPages = [
    ...
    new _payoutMethodTab.PayoutMethod()
  ];
