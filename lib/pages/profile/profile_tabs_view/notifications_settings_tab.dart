...
import 'package:ridealike/pages/profile/notification_settings.dart' as _notificationsSettingsTab;
...
class NotificationsSettingsTab extends StatefulWidget{
  @override
  _NotificationsSettingsTabState createState() => _NotificationsSettingsTabState();
}
...
class _NotificationsSettingsTabState extends State<NotificationsSettingsTab> {
  ...
  var _notHasCarPages = [
    ...
    new _notificationsSettingsTab.NotificationSettings()
  ];
