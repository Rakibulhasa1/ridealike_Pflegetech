...
import 'package:ridealike/pages/profile/give_us_feedback.dart' as _profileFeedbackTab;
...
class ProfileFeedbackTab extends StatefulWidget{
  @override
  _ProfileFeedbackTabState createState() => _ProfileFeedbackTabState();
}

class _ProfileFeedbackTabState extends State<ProfileFeedbackTab> {
  int _tab = 4;
  // bool _hasCar;
  ...
  var _notHasCarPages = [
    ...
    new _profileFeedbackTab.ProfileFeedback()
  ];
