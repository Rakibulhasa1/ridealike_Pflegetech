...
import 'package:ridealike/pages/profile/about_rideAlike_details.dart' as _aboutRideAlikeTab;
...
class AboutRideAlikeTab extends StatefulWidget{
  @override
  _AboutRideAlikeTabState createState() => _AboutRideAlikeTabState();
}

class _AboutRideAlikeTabState extends State<AboutRideAlikeTab> {
  int _tab = 4;
  // bool _hasCar;
  ...
  var _notHasCarPages = [
    ...
    new _aboutRideAlikeTab.AboutRideAlikeDetails(),
  ];
  ...
  Widget build (BuildContext context) => new Scaffold(
    ...
    //         selectedIcon: Icon(Icons.app_registration,color:Color(0xffFF8F68),),
    //         label: 'List your\nvehicle',
    //         //   maxLines: 2,
