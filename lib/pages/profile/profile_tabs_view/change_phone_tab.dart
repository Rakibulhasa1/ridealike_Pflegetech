...
import 'package:ridealike/pages/profile/change_your_phone.dart' as _profileChangePhoneView;
...
class ChangePhoneTab extends StatefulWidget{
  @override
  _ChangePhoneTabState createState() => _ChangePhoneTabState();
}
...
class _ChangePhoneTabState extends State<ChangePhoneTab> {
  ...
  var _notHasCarPages = [
    ...
    new _profileChangePhoneView.ChangePhoneNumber()
  ];
