...
import 'package:ridealike/pages/profile/about_you_details.dart' as _aboutYouTab;
...
class AboutYouTab extends StatefulWidget{
  @override
  _AboutYouTabState createState() => _AboutYouTabState();
}
...
class _AboutYouTabState extends State<AboutYouTab> {
  ...
  var _notHasCarPages = [
    ...
    new _aboutYouTab.AboutYouDetails(),
  ];
  ...
  void onTap(int tab) {
    if(tab == 4) {
      ProfileStatus.init().whenComplete(() => setState(() {}));
      //ProfileStatus.hasCar ? _hasCarPages[_tab] : _notHasCarPages[_tab]
    }
