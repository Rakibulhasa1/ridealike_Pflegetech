...
class SearchTabState extends State<SearchTab> {
  ...
  Widget build(BuildContext context) {
    (_loggedOutPages[0] as _searchCarTab.Search).object = widget.object;
    (_loggedInHadCarPages[0] as _searchCarTab.Search).object = widget.object;
    (_loggedInPages[0] as _searchCarTab.Search).object = widget.object;
    ...
    return Scaffold(
        ...
        //         icon: Icon(Icons.compare_arrows,color:Colors.grey,),
        //         selectedIcon:
        //         Icon(Icons.compare_arrows,color:Color(0xffFF8F68),),
        //         label:
        //           'Trips',
        //
        //
