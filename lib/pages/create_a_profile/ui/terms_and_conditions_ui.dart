...
class TermsAndConditionUi extends StatefulWidget {
  @override
  State createState() => TermsAndConditionUiState();
}

class TermsAndConditionUiState extends State<TermsAndConditionUi> {
...
//    final Map rcvdData = ModalRoute.of(context).settings.arguments;
    final CreateProfileResponse rcvdData = ModalRoute.of(context)!.settings.arguments as CreateProfileResponse;
...
Future<Resp> acceptTermsPolicy(String profileID) async {
  ...
  callAPI( acceptTermsAndConditionsUrl_profileServer, json.encode({
    "ProfileID": profileID,
  }),).then((resp) {
...
Future<Resp> acceptPromotion(String profileID) async {
  final completer=Completer<Resp>();
  callAPI(acceptPromotionalUpdatesUrl_profileServer, json.encode({
    "ProfileID": profileID,
  })).then((resp) {
    completer.complete(resp);
  });
